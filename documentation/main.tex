...
\item Take our icosahedron from before. For \(n = 2\), on each face, construct smaller \(n^{2}\) smaller equilateral triangles. Find the projections of the vertices triangles onto the unit sphere. Record the vertices and faces of the new polyhedron in a file. Repeat for \(n > 2\).
